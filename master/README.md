...
|---|---:|---|
| `people.csv` | 1451 | every person, dates, styles, honours, connectivity |
| `links.csv` | 1851 | every teacher-to-student link, graded, with its sources |
| `styles.csv` | 373 | every style with its ancestry back to the originating group |
| `kata.csv` | 480 | every kata: meaning, era, originator, modifier, provenance |
| `kata_people.csv` | 1978 | kata mapped to the people who made or carried them |
...
**Kata attributions still needing a person:** 27 of 1978 rows are marked
